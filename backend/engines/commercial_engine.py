...
class CommercialEngine:
    ...
    def calculate_commercial_cost(self) -> dict:
        ...
        structure_cost = floor_costs["structure_cost"] * 1.25  
        finish_cost = floor_costs["finish_cost"] * 1.25       
        ...
        subtotal_after_family = subtotal_before_family * family_adjustment_factor
