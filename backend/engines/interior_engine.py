...
class InteriorEngine:
    ...
    def calculate_interior_cost(self) -> dict:
        ...
        structure_cost = floor_costs["structure_cost"] * 0.5  
        finish_cost = floor_costs["finish_cost"] * 2.0  

        water_sump_cost = FIXED_COSTS["water_sump"] * 0.5
        septic_tank_cost = FIXED_COSTS["septic_tank"] * 0.5
